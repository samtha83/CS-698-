...
x_train = data_arr[:190].astype(np.float32)
y_train = labels_arr[:190]
x_test = data_arr[190:].astype(np.float32)# set the last 32 images as test dataset
y_test = labels_arr[190:]
